...
4. **`trait_scores` written by 3 producers, read by `curatedListCron` + `useVirtualList`** — clean fan-in/out, but the two earnings-based producers double-pull the earnings calendar (`sources.md` → Observation 6).
